...
extern PRECISION vec4 target_colour;
extern PRECISION vec4 progress_colour;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
	...
	vec3 tinted = target_colour.rgb * value;
	tex.rgb = mix(tex.rgb, tinted, progress_colour.rgb);
