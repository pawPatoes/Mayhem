...
SMODS.Joker {
	key = 'aurora_rave',
	loc_txt = {
		name = {'Aurora Rave', "{C:inactive,s:0.5}Party Time + Omniversal Catalyst{}"},
		text = {
			{
			...
			may.add_fusion_text('Wizard University', 'Planet Ibiza', may.get_condition('planet_ibiza')),
			{
...
SMODS.Joker {
	key = 'kepler',
	loc_txt = {
		name = {'Kepler', "{C:inactive,s:0.5}Cosmos + Omniversal Catalyst{}"},
		text = {
			{
...
SMODS.Joker {
	key = 'diskus_dominus',
	loc_txt = {
		name = {'Diskus Dominus', "{C:inactive,s:0.5}Diskus Kollectum + Collector's Edition{}"},
		text = {
			{
