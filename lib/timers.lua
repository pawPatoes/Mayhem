...
may.timer_functions['prismatic_scale'] = function()
	G.GAME.may_prismatic_scaling = (G.GAME.may_prismatic_scaling or 0) + 1
	may.a('Prismatic Scaling activated! (Round 150 threshold)', '5', 0.5, G.C.RED, 'talisman_eeechip', 0.7, 1)
end

may.timer_functions['demiurgic_scale'] = function()
	G.GAME.may_demiurgic_scaling = (G.GAME.may_demiurgic_scaling or 0) + 1
...
may.timer_functions['opalescent_get'] = function()
	G.GAME.may_opalescent_scaling = (G.GAME.may_opalescent_scaling or 0) + 1
	may.a('Opalescent Scaling activated!', '5', 0.5, G.C.RED, 'talisman_eeechip', 0.7, 1)
end

may.timer_functions['prismatic_fuse'] = function()
	G.GAME.may_prismatic_scaling = (G.GAME.may_prismatic_scaling or 0) + 1
	may.a('Prismatic Scaling activated!', '5', 0.5, G.C.RED, 'talisman_eeechip', 0.7, 1)
end

may.timer_functions['demiurgic_fuse'] = function()
	G.GAME.may_demiurgic_scaling = (G.GAME.may_demiurgic_scaling or 0) + 1
