...
There's a spreadsheet of features i will most likely add to Mayhem. If you want your idea to be there, you need to make a post in the suggestions channel in the discord server and it also has to be good enough.
...
WARNING THIS DOES NOT AFFECT MAYHEM DEPENDENCIES. THEY ARE SEPERATE PROJECTS AND ONLY MAYHEM IS CC0. ADDITIONALLY, CERTAIN ASSETS (AUDIO) HAVE SEPARATE LICENSES. SIMPLY PUT, YOU CAN ONLY USE THE CODE, TEXTURES AND THE MUSIC. BE CAREFUL MATE.
